...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'dashboard.totalItems': 'Total Автоматизированная система выставленияs',
    'dashboard.totalClients': 'Total Clients',
    'dashboard.recentItems': 'Recent Автоматизированная система выставленияs',
    'dashboard.quickActions': 'Quick Actions',
    'dashboard.overdue': 'Overdue',
    'dashboard.newItem': 'New Автоматизированная система выставления',
    'dashboard.viewAll': 'View All',
    'dashboard.last30Days': 'Last 30 Days',
    'dashboard.noItems': 'No Автоматизированная система выставленияs yet. Create your first one!',

    // Create / Form
    'create.title': 'New Автоматизированная система выставления',
    'create.editTitle': 'Edit Автоматизированная система выставления',
    ...
    'create.submit': 'Create Автоматизированная система выставления',
    'create.update': 'Update Автоматизированная система выставления',
