    ...
    <div className="min-h-screen" style={{ background: '#0c0a1d' }}>
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="flex items-center gap-3 mb-6">
          <Shield className="w-6 h-6" style={{ color: '#4b3d66' }} />
          <h1 className="text-2xl font-bold" style={{ fontFamily: "'Cabinet Grotesk', sans-serif", color: '#e4e4e4' }}>{t('legal.privacyPolicy')}</h1>
        </div>
